...
import com.icinfo.lpsp.wechat.material.enums.EMateriaType;
...
public class MaterialManager {
     ...
     * @throws Exception
     */
    public static String addOrtherMaterial(String access_token,String url,String type)throws Exception{
      Map<String,String> map =  MaterialApi.upload(access_token,url,type);
        return map.get("");
    }
}
